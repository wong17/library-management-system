    ...
    public class CategoryRepository(ISqlConnector sqlConnector) : ICategoryRepository
    {
        ...
        public async Task<ApiResponse> Create(Category entity)
        {
            ...
            try
            {
                ...
                DataTable result = await _sqlConnector.ExecuteDataTableAsync("[Library].uspInsertCategory", CommandType.StoredProcedure, parameters);
        ...
        public async Task<ApiResponse> CreateMany(IEnumerable<Category> entities)
        {
            ...
            try
            {
                ...
                DataSet result = await _sqlConnector.ExecuteSPWithTVPMany(table, "[Library].CategoryType", "[Library].uspInsertManyCategory", "@Categories");
                /* Convertir respuesta de la base de datos a objeto de tipo ApiResponse */
        ...
        public async Task<ApiResponse> Delete(int id)
        {
            ...
            try
            {
                ...
                DataTable result = await _sqlConnector.ExecuteDataTableAsync("[Library].uspDeleteCategory", CommandType.StoredProcedure, parameters);
                /* Convertir respuesta de la base de datos a objeto de tipo ApiResponse */
                response = _sqlConnector.DataRowToObject<ApiResponse>(result.Rows[0]);
                /* Sino se pudo convertir la fila a un objeto de tipo ApiResponse */
                if (response is null)
        ...
        public async Task<ApiResponse> GetAll()
        {
            ...
            try
            {
                ...
                DataTable result = await _sqlConnector.ExecuteDataTableAsync("[Library].uspGetCategory", CommandType.StoredProcedure);
                /* Convertir DataTable a una Lista */
                IEnumerable<Category> categories = _sqlConnector.DataTableToList<Category>(result);
        ...
        public async Task<ApiResponse> GetById(int id)
        {
            ...
            {
                /* Ejecutar procedimiento almacenado */
                DataTable result = await _sqlConnector.ExecuteDataTableAsync("[Library].uspGetCategory", CommandType.StoredProcedure, parameters);
                ...
                Category? category = _sqlConnector.DataRowToObject<Category>(result.Rows[0]);
        ...
        public async Task<ApiResponse> Update(Category entity)
        {
            ...
            {
                /* Ejecutar procedimiento almacenado que recibe cada atributo por parámetro */
                DataTable result = await _sqlConnector.ExecuteDataTableAsync("[Library].uspUpdateCategory", CommandType.StoredProcedure, parameters);
                /* Convertir respuesta de la base de datos a objeto de tipo ApiResponse */
                response = _sqlConnector.DataRowToObject<ApiResponse>(result.Rows[0]);
                /* Sino se pudo convertir la fila a un objeto de tipo ApiResponse */
                if (response is null)
        ...
        public async Task<ApiResponse> UpdateMany(IEnumerable<Category> entities)
        {
            ...
            {
                /* Ejecutar procedimiento almacenado que recibe tabla por parámetro */
                DataTable result = await _sqlConnector.ExecuteSPWithTVP(table, "[Library].CategoryType", "[Library].uspUpdateManyCategory", "@Categories");
                /* Convertir respuesta de la base de datos a objeto de tipo ApiResponse */
                response = _sqlConnector.DataRowToObject<ApiResponse>(result.Rows[0]);
                /* Sino se pudo convertir la fila a un objeto de tipo ApiResponse */
                if (response is null)
