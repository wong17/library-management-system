...
namespace LibraryManagementSystem.Entities.Dtos.Library
{
    public class MonographInsertDto
    {
        ...
        [RegularExpression(@"^[a-zA-Z0-9\-\. ]+$", ErrorMessage = "Clasificación de la monografía solo puede tener letras, guiones, puntos y espacios")]
        ...
        [RegularExpression(@"^[a-zA-Z0-9\-\.\, ]+$", ErrorMessage = "Titulo de la monografía solo puede tener letras, números, guiones, puntos, comas y espacios")]
        ...
        [RegularExpression(@"^[a-zA-Z\.\. ]+$", ErrorMessage = "Tutor de la monografía solo puede tener letras, puntos, comas y espacios")]
