...
public class AuthorService : CreateUpdateManyRequestService<AuthorInsertDto, AuthorUpdateDto>
{
    public AuthorService() : base(AppSettings.Instance.AuthorEndpointUrl)
    {
    }
}