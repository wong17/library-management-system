...
public class MonographService : BaseRequestService<MonographInsertDto, MonographUpdateDto>
{
    public MonographService() : base(AppSettings.Instance.MonographEndpointUrl)
    {
    }
}