...
public class PageService : IPageService
{
    ...
    public PageService()
    {
        ...
        Configure<BookViewModel, BookPage>();
        Configure<MonographViewModel, MonographPage>();

        Configure<CategoryViewModel, CategoryPage>();
        Configure<SubCategoryViewModel, SubCategoryPage>();
        Configure<AuthorViewModel, AuthorPage>();
        Configure<PublisherViewModel, PublisherPage>();

        Configure<UserViewModel, UserPage>();
        Configure<RoleViewModel, RolePage>();
